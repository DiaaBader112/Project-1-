...
# time.sleep(1)
# driver.current_url
# # SauceLab_item1.click()
# images_link = driver.find_element(By.CLASS_NAME, "inventory_item_img")
...
# def Price(driver):
#     lohi =  driver.find_elements(by=By.XPATH, value='//option[@value="lohi"]')
#     hilo = driver.find_elements(by=By.XPATH, value='//option[@value="hilo"]')
#     return driver
#
